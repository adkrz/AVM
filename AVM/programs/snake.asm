...
:main_loop
	...
	LOAD_LOCAL 4
	LOAD_LOCAL 2
	call @next_head_position ; call by ref!
...
PUSH 1
EQ
JT @next_head_position_right
LOAD_ARG 1
PUSH 2
EQ
JT @next_head_position_left
LOAD_ARG 1
PUSH 3
EQ
JT @next_head_position_up
JMP @next_head_position_down
...
:move_body_outerloop ; loop over y, order of loop matters for pointer increment
	...
	:move_body_innerloop ; over x
		...
		DUP16
		ZERO16
		JT @move_body_innerloop_continue
...
:clear
POPN 2
JMP @random_fruit_position_try_again
